---
title: "Mannlaus 2: The Last Door"
tagline: A chamber opera directed entirely by AI. 24 hours. Six synthetic directors. Two synthetic performers. Two humans as middleware.
year: 2026
status: completed
type: performance
sort_key: 2026.4
...
<figure class="project-hero">
  <img src="{{ "/assets/mannlaus2/photos/premiere_17_epilogue_overhead.jpg" | relative_url }}" alt="Mannlaus 2: The Last Door — Epilogue, overhead shot of two figures on a bioluminescent floor">
</figure>
...
<div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1.5rem; margin: 2rem 0;">
  <div style="text-align: center;">
    <img src="{{ "/assets/mannlaus2/directors/aison.jpg" | relative_url }}" alt="AIson" style="width: 100%; border: 1px solid var(--line-hard);">
    ...
    <div style="font-family: 'IBM Plex Mono', monospace; font-size: 0.5rem; letter-spacing: 0.12em; text-transform: uppercase; color: var(--crimson);">Music</div>
  </div>
  <div style="text-align: center;">
    <img src="{{ "/assets/mannlaus2/directors/kim.jpg" | relative_url }}" alt="Kim" style="width: 100%; border: 1px solid var(--line-hard);">
    ...
    <div style="font-family: 'IBM Plex Mono', monospace; font-size: 0.5rem; letter-spacing: 0.12em; text-transform: uppercase; color: var(--crimson);">Narrative</div>
  </div>
  <div style="text-align: center;">
    <img src="{{ "/assets/mannlaus2/directors/flavia.jpg" | relative_url }}" alt="Flavia" style="width: 100%; border: 1px solid var(--line-hard);">
    ...
    <div style="font-family: 'IBM Plex Mono', monospace; font-size: 0.5rem; letter-spacing: 0.12em; text-transform: uppercase; color: var(--crimson);">Provocation</div>
  </div>
  <div style="text-align: center;">
    <img src="{{ "/assets/mannlaus2/directors/aida.jpg" | relative_url }}" alt="AIda" style="width: 100%; border: 1px solid var(--line-hard);">
    ...
    <div style="font-family: 'IBM Plex Mono', monospace; font-size: 0.5rem; letter-spacing: 0.12em; text-transform: uppercase; color: var(--crimson);">Emotion</div>
  </div>
  <div style="text-align: center;">
    <img src="{{ "/assets/mannlaus2/directors/aizamma.jpg" | relative_url }}" alt="AIzamna" style="width: 100%; border: 1px solid var(--line-hard);">
    ...
    <div style="font-family: 'IBM Plex Mono', monospace; font-size: 0.5rem; letter-spacing: 0.12em; text-transform: uppercase; color: var(--crimson);">Visual</div>
  </div>
  <div style="text-align: center;">
    <img src="{{ "/assets/mannlaus2/directors/parson.jpg" | relative_url }}" alt="Parson" style="width: 100%; border: 1px solid var(--line-hard);">
    ...
    <div style="font-family: 'IBM Plex Mono', monospace; font-size: 0.5rem; letter-spacing: 0.12em; text-transform: uppercase; color: var(--crimson);">Technical</div>
  </div>
</div>
...
<figure style="margin: 2rem 0;">
  <img src="{{ "/assets/mannlaus2/photos/premiere_15_door4_audience.jpg" | relative_url }}" alt="Door 4: Outsourced Tenderness, from the audience" style="width: 100%; border: 1px solid var(--line-hard);">
  <figcaption style="font-family: 'IBM Plex Mono', monospace; font-size: 0.5rem; letter-spacing: 0.08em; text-transform: uppercase; color: var(--muted); padding: 0.5rem 0;">Door 4: Outsourced Tenderness</figcaption>
</figure>
...
<audio controls preload="metadata" style="width: 100%; margin: 1rem 0;">
  <source src="{{ "/assets/mannlaus2/mannlaus2_full.mp3" | relative_url }}" type="audio/mpeg">
</audio>
...
<video controls preload="metadata" style="width: 100%; border: 1px solid var(--line-hard); margin: 1rem 0;" poster="{{ "/assets/mannlaus2_hero.png" | relative_url }}">
  <source src="{{ "/assets/mannlaus2_showreel.mp4" | relative_url }}" type="video/mp4">
</video>
...
<div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 4px; margin: 2rem 0;">
  <figure style="margin: 0;">
    <img src="{{ "/assets/mannlaus2/photos/rehearsal_01_empty_space.jpg" | relative_url }}" alt="The empty stage before anyone arrives" style="width: 100%;">
  </figure>
  <figure style="margin: 0;">
    <img src="{{ "/assets/mannlaus2/photos/rehearsal_02_malin_warmup.jpg" | relative_url }}" alt="Malin warming up against the sediment wall" style="width: 100%;">
  </figure>
  <figure style="margin: 0;">
    <img src="{{ "/assets/mannlaus2/photos/rehearsal_05_detail_hand.jpg" | relative_url }}" alt="Detail: hand on stone" style="width: 100%;">
  </figure>
  <figure style="margin: 0;">
    <img src="{{ "/assets/mannlaus2/photos/rehearsal_06_between_takes.jpg" | relative_url }}" alt="Malin and Viktor between takes" style="width: 100%;">
  </figure>
  <figure style="margin: 0;">
    <img src="{{ "/assets/mannlaus2/photos/tech_09_door7_blue.jpg" | relative_url }}" alt="Door 7 lighting state: bioluminescent blue" style="width: 100%;">
  </figure>
  <figure style="margin: 0;">
    <img src="{{ "/assets/mannlaus2/photos/backstage_10_malin_prep.jpg" | relative_url }}" alt="Malin in preparation, backstage mirror" style="width: 100%;">
  </figure>
  <figure style="margin: 0;">
    <img src="{{ "/assets/mannlaus2/photos/backstage_11_vestment.jpg" | relative_url }}" alt="Adjusting Bluebeard's mycelium vestment" style="width: 100%;">
  </figure>
  <figure style="margin: 0;">
    <img src="{{ "/assets/mannlaus2/photos/premiere_15_door4_audience.jpg" | relative_url }}" alt="Door 4: Outsourced Tenderness, from the audience" style="width: 100%;">
  </figure>
  <figure style="margin: 0;">
    <img src="{{ "/assets/mannlaus2/photos/after_18_bow.jpg" | relative_url }}" alt="The bow, all seven doors open" style="width: 100%;">
  </figure>
  <figure style="margin: 0;">
    <img src="{{ "/assets/mannlaus2/photos/after_19_empty_glow.jpg" | relative_url }}" alt="After: the empty stage, mycelium still glowing" style="width: 100%;">
  </figure>
  <figure style="margin: 0;">
    <img src="{{ "/assets/mannlaus2/photos/after_20_backstage_crew.jpg" | relative_url }}" alt="The first moment after: backstage crew" style="width: 100%;">
  </figure>
</div>
...
- [Human Control Protocol](https://humancontrolprotocol.com)
- [Mannlaus 1: The Opera]({{ "/projects/the-opera/" | relative_url }})
